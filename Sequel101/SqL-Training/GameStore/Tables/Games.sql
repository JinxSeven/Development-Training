CREATE TABLE Games 
	(
		...
		GameCreatedDate DATETIMEOFFSET NOT NULL
	);

ALTER TABLE Games
ALTER COLUMN GameCategory NVARCHAR(255);

SELECT * FROM Games;

TRUNCATE TABLE Games;

-- Insert 5 popular PC games into the Games table

INSERT INTO Games (GameId, GameName, GameCategory, GameDescription, GamePrice, GameCreatedDate)
VALUES (NEWID(), 'Grand Theft Auto V', 'Action-Adventure', 'Experience the intertwined lives of three criminals in a thrilling open-world adventure.', 29.99, SYSDATETIMEOFFSET());
...
INSERT INTO Games (GameId, GameName, GameCategory, GameDescription, GamePrice, GameCreatedDate)
VALUES (NEWID(), 'The Last of Us Part I', 'Action-Adventure/Survival horror', 'Experience the emotional storytelling and unforgettable characters of Joel and Ellie in a reimagined version of the acclaimed game.', 49.99, SYSDATETIMEOFFSET());